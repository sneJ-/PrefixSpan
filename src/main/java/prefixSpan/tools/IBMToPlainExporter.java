...
import prefixSpan.IBM_DataGeneratorInputDecoder;
import prefixSpan.InputDecoder;

/**
 * Exports files from IBM Data Generator format to plainInputFormat.
 * @author Jens Röwekamp
 *
 */
public class IBMToPlainExporter {

	public static void main(String[] args) throws Exception {
		if(args.length == 2){
			final ExecutionEnvironment env = ExecutionEnvironment.getExecutionEnvironment();
			InputDecoder decoder = new IBM_DataGeneratorInputDecoder();
			...
			System.err.println("IBMToPlainExporter inputFile outputFile");
		}
	}
}
